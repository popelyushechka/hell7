let question_arr = ["В каком году «паучок» впервые появился на страницах комиксов?","Гарри, лучший друг Питера, является сыном какого злодея?","Как по-настоящему зовут Человека-паука?","Что было такого «необычного» в пауке, который укусил Питера?","Как звали родителей Питера?"]
let a1_arr = ["1962","Стервятник","Питер Бенджамин Паркер","Радиоактивность","Бен и Мэй"]
let a2_arr = ["1968","Зеленый гоблин","Питер Габриэл Паркер","Измененные гены","Ричард и Мэри"]
let a3_arr = ["1987","Веном","Питер Бенджамин Роджер","Он был пришельцем","Томас и Марта"]
let a4_arr = ["2000","Ящер","Питер Мэри Роджер","Он был мутантом","Хеппи и Мэй"]
let answer_arr = ["1962","Зеленый гоблин","Питер Бенджамин Паркер","Радиоактивность","Ричард и Мэри"]
let n_right_answer_arr = [1,2,1,1,2]
